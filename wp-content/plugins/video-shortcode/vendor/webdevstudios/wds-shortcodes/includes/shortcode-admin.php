...
abstract class WDS_Shortcode_Admin extends Shortcode_Button {
	...
	public function __construct( $shortcode = '', $version = '', $atts_defaults = array() ) {
		...
		// Security: do not register wp_ajax_nopriv_scb_parse_shortcode — that endpoint runs
		// do_shortcode() and must only be available to logged-in editors (TinyMCE preview).
	}
