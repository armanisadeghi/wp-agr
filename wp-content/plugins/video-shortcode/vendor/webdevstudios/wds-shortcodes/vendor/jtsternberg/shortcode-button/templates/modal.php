	...
	<div class="ui-dialog" id="scb-modal" tabindex="-1"><?php // http://stackoverflow.com/a/32912224 ?>
		<div class="ui-dialog-titlebar">
			...
			<button type="button" class="ui-button ui-button-icon-only ui-dialog-titlebar-close scb-close" role="button" title="<?php _e( 'Close' ); ?>">
				...
				<span class="ui-button-text"><?php esc_html_e( 'Close' ); ?></span>
			</button>
		</div>
		<div id="scb-inner">
		...
		<div class="ui-dialog-buttonpane ui-widget-content ui-helper-clearfix">
			<div class="ui-dialog-buttonset">
				<button type="button" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only scb-cancel" role="button"><?php esc_html_e( 'Cancel' ); ?></button>
				<button type="button" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only button-primary scb-insert" role="button"><?php esc_html_e( 'Insert Shortcode' ); ?></button>
			</div>
		</div>
	</div>
