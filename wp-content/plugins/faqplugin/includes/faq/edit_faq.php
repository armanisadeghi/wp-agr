...
if(isset($_POST['submit'])){
	...
	if($success){
		setFlashData('success','FAQ updated');
...
$Faqs = $wpdb->get_results( "SELECT * FROM ".$table." where ID = ".$_GET['id']);
if(count($Faqs) <= 0)
{
	setFlashData('error','FAQs not found');
	echo '<script>window.location.href="'.admin_url("admin.php?page=Manage_FAQs").'"</script>';
}
...
<div class="container">
  ...
  <form action ="<?php echo $_SERVER['REQUEST_URI']; ?>" method ="post">
   ...
   <div class="form-group">
      ...
      <input type="text" class="form-control" id="qes" value="<?php echo $Faqs[0]->Question; ?>" placeholder="Enter question" name="qes">
   ...
   <div class="form-group">
      ...
      <input type="text" class="form-control" value="<?php echo $Faqs[0]->Answer; ?>" id="ans" placeholder="Enter Answer" name="ans">
    ...
    <div class="form-group">
      ...
      <select class="form-control" name="category_id">
          ...
          <?php foreach($categories as $category){ ?>
            <option <?php echo ($Faqs[0]->Category_id == $category->ID) ? 'selected="selected"' : ''; ?> value="<?php echo $category->ID; ?>"><?php echo $category->Name; ?></option>
          <?php } ?>
      </select>
      ...
      <select class="form-control" name="status">
          <option <?php echo ($Faqs[0]->Status == 1) ? 'selected="selected"' : ''; ?> value="1">Enabled</option>
          <option <?php echo ($Faqs[0]->Status == 0) ? 'selected="selected"' : ''; ?> value="0">Disabled</option>
      </select>
