...
use BracketSpace\Notification\Dependencies\Composer\Installer\InstallerEvent;
use BracketSpace\Notification\Dependencies\Composer\IO\BufferIO;
use BracketSpace\Notification\Dependencies\Composer\IO\ConsoleIO;
...
use BracketSpace\Notification\Dependencies\Composer\PartialComposer;
...
use BracketSpace\Notification\Dependencies\Composer\Plugin\PreCommandRunEvent;
...
use BracketSpace\Notification\Dependencies\Composer\Script;
use BracketSpace\Notification\Dependencies\Composer\Installer\PackageEvent;
use BracketSpace\Notification\Dependencies\Composer\Installer\BinaryInstaller;
use BracketSpace\Notification\Dependencies\Composer\Util\ProcessExecutor;
use BracketSpace\Notification\Dependencies\Composer\Script\Event as ScriptEvent;
use BracketSpace\Notification\Dependencies\Composer\Autoload\ClassLoader;
use BracketSpace\Notification\Dependencies\Symfony\Component\Console\Application;
...
use BracketSpace\Notification\Dependencies\Symfony\Component\Process\PhpExecutableFinder;
use BracketSpace\Notification\Dependencies\Symfony\Component\Process\ExecutableFinder;
        ...
        try {
            ...
            foreach ($listeners as $callable) {
                ...
                if (!is_string($callable)) {
                    ...
                    if (defined('BracketSpace\Notification\Dependencies\Composer\Script\ScriptEvents::'.str_replace('-', '_', strtoupper($event->getName())))) {
                    ...
                    $args = implode(' ', array_map(['BracketSpace\Notification\Dependencies\Composer\Util\ProcessExecutor', 'escape'], $additionalArgs));
