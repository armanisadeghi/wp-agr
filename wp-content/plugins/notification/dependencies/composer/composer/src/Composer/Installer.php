...
use BracketSpace\Notification\Dependencies\Composer\Autoload\AutoloadGenerator;
use BracketSpace\Notification\Dependencies\Composer\Console\GithubActionError;
use BracketSpace\Notification\Dependencies\Composer\DependencyResolver\DefaultPolicy;
use BracketSpace\Notification\Dependencies\Composer\DependencyResolver\LocalRepoTransaction;
use BracketSpace\Notification\Dependencies\Composer\DependencyResolver\LockTransaction;
use BracketSpace\Notification\Dependencies\Composer\DependencyResolver\Operation\UpdateOperation;
use BracketSpace\Notification\Dependencies\Composer\DependencyResolver\Operation\InstallOperation;
use BracketSpace\Notification\Dependencies\Composer\DependencyResolver\Operation\UninstallOperation;
use BracketSpace\Notification\Dependencies\Composer\DependencyResolver\PoolOptimizer;
use BracketSpace\Notification\Dependencies\Composer\DependencyResolver\Pool;
use BracketSpace\Notification\Dependencies\Composer\DependencyResolver\Request;
use BracketSpace\Notification\Dependencies\Composer\DependencyResolver\Solver;
use BracketSpace\Notification\Dependencies\Composer\DependencyResolver\SolverProblemsException;
use BracketSpace\Notification\Dependencies\Composer\DependencyResolver\PolicyInterface;
use BracketSpace\Notification\Dependencies\Composer\Downloader\DownloadManager;
use BracketSpace\Notification\Dependencies\Composer\Downloader\TransportException;
use BracketSpace\Notification\Dependencies\Composer\EventDispatcher\EventDispatcher;
use BracketSpace\Notification\Dependencies\Composer\Filter\PlatformRequirementFilter\IgnoreListPlatformRequirementFilter;
use BracketSpace\Notification\Dependencies\Composer\Filter\PlatformRequirementFilter\PlatformRequirementFilterFactory;
use BracketSpace\Notification\Dependencies\Composer\Filter\PlatformRequirementFilter\PlatformRequirementFilterInterface;
use BracketSpace\Notification\Dependencies\Composer\Installer\InstallationManager;
use BracketSpace\Notification\Dependencies\Composer\Installer\InstallerEvents;
...
use BracketSpace\Notification\Dependencies\Composer\Package\Dumper\ArrayDumper;
...
use BracketSpace\Notification\Dependencies\Composer\Repository\ArrayRepository;
...
use BracketSpace\Notification\Dependencies\Composer\Repository\InstalledArrayRepository;
...
use BracketSpace\Notification\Dependencies\Composer\Repository\LockArrayRepository;
use BracketSpace\Notification\Dependencies\Composer\Script\ScriptEvents;
...
class Installer
{
    ...
    protected function doUpdate(InstalledRepositoryInterface $localRepo, bool $doInstall): int
    {
        ...
        } catch (\BracketSpace\Notification\Dependencies\Seld\JsonLint\ParsingException $e) {
            if ($this->updateAllowList !== null || $this->updateMirrors) {
        ...
        \BracketSpace\Notification\Dependencies\Composer\Semver\CompilingMatcher::clear();
