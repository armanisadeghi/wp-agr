...
use BracketSpace\Notification\Dependencies\Composer\Repository\Vcs\VcsDriverInterface;
...
use BracketSpace\Notification\Dependencies\Composer\Package\Loader\InvalidPackageException;
use BracketSpace\Notification\Dependencies\Composer\Package\Loader\LoaderInterface;
...
use BracketSpace\Notification\Dependencies\Composer\Util\HttpDownloader;
...
class VcsRepository extends ArrayRepository implements ConfigurableRepositoryInterface
{
    ...
    public function __construct(array $repoConfig, IOInterface $io, Config $config, HttpDownloader $httpDownloader, ?EventDispatcher $dispatcher = null, ?ProcessExecutor $process = null, ?array $drivers = null, ?VersionCacheInterface $versionCache = null)
    {
        ...
        $this->drivers = $drivers ?: [
            'github' => 'BracketSpace\Notification\Dependencies\Composer\Repository\Vcs\GitHubDriver',
            'gitlab' => 'BracketSpace\Notification\Dependencies\Composer\Repository\Vcs\GitLabDriver',
            'bitbucket' => 'BracketSpace\Notification\Dependencies\Composer\Repository\Vcs\GitBitbucketDriver',
            'git-bitbucket' => 'BracketSpace\Notification\Dependencies\Composer\Repository\Vcs\GitBitbucketDriver',
            'git' => 'BracketSpace\Notification\Dependencies\Composer\Repository\Vcs\GitDriver',
            'hg' => 'BracketSpace\Notification\Dependencies\Composer\Repository\Vcs\HgDriver',
            'perforce' => 'BracketSpace\Notification\Dependencies\Composer\Repository\Vcs\PerforceDriver',
            'fossil' => 'BracketSpace\Notification\Dependencies\Composer\Repository\Vcs\FossilDriver',
            // svn must be last because identifying a subversion server for sure is practically impossible
            'svn' => 'BracketSpace\Notification\Dependencies\Composer\Repository\Vcs\SvnDriver',
        ];
    ...
    /**
     * @return \BracketSpace\Notification\Dependencies\Composer\Package\CompletePackage|\BracketSpace\Notification\Dependencies\Composer\Package\CompleteAliasPackage|null|false null if no cache present, false if the absence of a version was cached
     */
