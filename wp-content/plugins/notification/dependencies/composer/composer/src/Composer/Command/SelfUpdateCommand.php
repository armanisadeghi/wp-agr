...
use BracketSpace\Notification\Dependencies\Composer\Downloader\FilesystemException;
...
EOT
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        class_exists('BracketSpace\Notification\Dependencies\Composer\Util\Platform');
        class_exists('BracketSpace\Notification\Dependencies\Composer\Downloader\FilesystemException');
