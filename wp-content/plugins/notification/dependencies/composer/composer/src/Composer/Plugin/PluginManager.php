...
use BracketSpace\Notification\Dependencies\Composer\EventDispatcher\EventSubscriberInterface;
use BracketSpace\Notification\Dependencies\Composer\Installer\InstallerInterface;
...
use BracketSpace\Notification\Dependencies\Composer\Plugin\Capability\Capability;
...
class PluginManager
{
    ...
    public function registerPackage(PackageInterface $package, bool $failOnMissingClasses = false, bool $isGlobalPlugin = false): void
    {
        ...
        foreach ($map['files'] as $fileIdentifier => $file) {
            ...
            \BracketSpace\Notification\Dependencies\Composer\Autoload\composerRequire($fileIdentifier, $file);
        }
        ...
        foreach ($classes as $class) {
            ...
            if ($oldInstallerPlugin) {
                if (!is_a($class, 'BracketSpace\Notification\Dependencies\Composer\Installer\InstallerInterface', true)) {
                ...
                if (!is_a($class, 'BracketSpace\Notification\Dependencies\Composer\Plugin\PluginInterface', true)) {
