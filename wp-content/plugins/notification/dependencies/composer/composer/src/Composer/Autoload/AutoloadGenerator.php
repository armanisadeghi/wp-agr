...
namespace BracketSpace\Notification\Dependencies\Composer\Autoload;

use BracketSpace\Notification\Dependencies\Composer\ClassMapGenerator\ClassMap;
use BracketSpace\Notification\Dependencies\Composer\ClassMapGenerator\ClassMapGenerator;
...
use BracketSpace\Notification\Dependencies\Composer\Util\PackageSorter;
...
EOF;
        ...
        $classMap->addClass('BracketSpace\Notification\Dependencies\Composer\InstalledVersions', $vendorPath . '/composer/InstalledVersions.php');
        $classMap->sort();
...
class ComposerAutoloaderInit$suffix
{
    ...
    {
        if ('BracketSpace\\Notification\\Dependencies\\Composer\\Autoload\\ClassLoader' === \$class) {
            require __DIR__ . '/ClassLoader.php';
        }
    }

    /**
     * @return \BracketSpace\Notification\Dependencies\Composer\Autoload\ClassLoader
     */
...
PLATFORM_CHECK;
        ...
        self::\$loader = \$loader = new \\BracketSpace\\Notification\\Dependencies\\Composer\\Autoload\\ClassLoader(\\dirname(__DIR__));
...
INCLUDE_PATH;
        ...
        call_user_func(\BracketSpace\Notification\Dependencies\Composer\Autoload\ComposerStaticInit$suffix::getInitializer(\$loader));
...
REGISTER_LOADER;
        ...
        if ($useIncludeFiles) {
            $file .= <<<INCLUDE_FILES
        \$filesToLoad = \BracketSpace\Notification\Dependencies\Composer\Autoload\ComposerStaticInit$suffix::\$files;
