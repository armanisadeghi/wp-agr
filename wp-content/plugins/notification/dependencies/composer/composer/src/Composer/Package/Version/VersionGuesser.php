...
namespace BracketSpace\Notification\Dependencies\Composer\Package\Version;

use BracketSpace\Notification\Dependencies\Composer\Config;
use BracketSpace\Notification\Dependencies\Composer\Pcre\Preg;
use BracketSpace\Notification\Dependencies\Composer\Repository\Vcs\HgDriver;
use BracketSpace\Notification\Dependencies\Composer\IO\NullIO;
use BracketSpace\Notification\Dependencies\Composer\Semver\VersionParser as SemverVersionParser;
use BracketSpace\Notification\Dependencies\Composer\Util\Git as GitUtil;
...
use BracketSpace\Notification\Dependencies\Composer\Util\Svn as SvnUtil;
use BracketSpace\Notification\Dependencies\React\Promise\CancellablePromiseInterface;
                        ...
                        if (strlen($output) < $length || (strlen($output) === $length && $lastIndex < $index)) {
                            ...
                            if ($length === 0) {
                                foreach ($promises as $promise) {
                                    ...
                                    \BracketSpace\Notification\Dependencies\React\Promise\resolve($promise)->cancel();
                                }
                            }
                        }
                    });
