...
class RootPackageLoader extends ArrayLoader
{
     ...
     */
    public function load(array $config, string $class = 'BracketSpace\Notification\Dependencies\Composer\Package\RootPackage', ?string $cwd = null): BasePackage
    {
        if ($class !== 'BracketSpace\Notification\Dependencies\Composer\Package\RootPackage') {
