...
use BracketSpace\Notification\Dependencies\Composer\Config\ConfigSourceInterface;
...
class Config
{
     ...
     * "scripts": {
     *   "watch": [
     *     "BracketSpace\\Notification\\Dependencies\\Composer\\Config::disableProcessTimeout",
