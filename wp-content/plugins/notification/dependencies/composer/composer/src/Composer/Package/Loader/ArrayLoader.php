...
class ArrayLoader implements LoaderInterface
{
    ...
    {
        if ($class !== 'BracketSpace\Notification\Dependencies\Composer\Package\CompletePackage' && $class !== 'BracketSpace\Notification\Dependencies\Composer\Package\RootPackage') {
    ...
    public function loadPackages(array $versions): array
    {
        ...
        foreach ($versions as $version) {
            $package = $this->createObject($version, 'BracketSpace\Notification\Dependencies\Composer\Package\CompletePackage');
