...
use BracketSpace\Notification\Dependencies\Composer\Package\Version\StabilityFilter;
...
use BracketSpace\Notification\Dependencies\Composer\Semver\CompilingMatcher;
...
use BracketSpace\Notification\Dependencies\Composer\MetadataMinifier\MetadataMinifier;
...
class ComposerRepository extends ArrayRepository implements ConfigurableRepositoryInterface, AdvisoryProviderInterface
{
    ...
    private function asyncFetchFile(string $filename, string $cacheKey, ?string $lastModifiedTime = null): PromiseInterface
    {
        ...
        if (isset($this->packagesNotFoundCache[$filename])) {
            return \BracketSpace\Notification\Dependencies\React\Promise\resolve(['packages' => []]);
        }
        ...
        if (isset($this->freshMetadataUrls[$filename]) && $lastModifiedTime) {
            ...
            $promise = \BracketSpace\Notification\Dependencies\React\Promise\resolve(true);
