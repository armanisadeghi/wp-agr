...
use BracketSpace\Notification\Dependencies\JsonSchema\Exception\RuntimeException;
...
class Curl extends AbstractRetriever
{
    ...
    public function retrieve($uri)
    {
        ...
        if (false === $response) {
            throw new \BracketSpace\Notification\Dependencies\JsonSchema\Exception\ResourceNotFoundException('JSON schema not found');
        }
