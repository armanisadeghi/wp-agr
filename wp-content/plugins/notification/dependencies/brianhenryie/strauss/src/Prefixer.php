...
namespace BracketSpace\Notification\Dependencies\BrianHenryIE\Strauss;

use BracketSpace\Notification\Dependencies\BrianHenryIE\Strauss\Composer\ComposerPackage;
use BracketSpace\Notification\Dependencies\BrianHenryIE\Strauss\Composer\Extra\StraussConfig;
use BracketSpace\Notification\Dependencies\BrianHenryIE\Strauss\Types\NamespaceSymbol;
use Exception;
use BracketSpace\Notification\Dependencies\League\Flysystem\Filesystem;
use BracketSpace\Notification\Dependencies\League\Flysystem\Local\LocalFilesystemAdapter;
use BracketSpace\Notification\Dependencies\Symfony\Component\Filesystem\Exception\FileNotFoundException;
...
class Prefixer
{
     ...
     * @return void
     * @throws \BracketSpace\Notification\Dependencies\League\Flysystem\FilesystemException
     */
