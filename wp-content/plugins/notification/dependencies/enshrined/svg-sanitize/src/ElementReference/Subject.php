...
class Subject
{
     ...
     * @return bool
     * @throws \BracketSpace\Notification\Dependencies\enshrined\svgSanitize\Exceptions\NestingException
     */
    public function hasInfiniteLoop(array $subjects = [], $level = 1)
    {
        if ($level > $this->useNestingLimit) {
            throw new \BracketSpace\Notification\Dependencies\enshrined\svgSanitize\Exceptions\NestingException('Nesting level too high, aborting', 1570713498, null, $this->getElement());
        }
