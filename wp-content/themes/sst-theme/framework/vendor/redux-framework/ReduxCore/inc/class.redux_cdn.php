...
// Exit if accessed directly
    ...
    if ( ! class_exists( 'Redux_CDN' ) ) {
        class Redux_CDN {
            ...
            private static function _cdn( $register = true, $handle = '', $src_cdn = false, $deps = array(), $ver = false, $footer_or_media = false, $is_script = true ) {
            ...
            private static function _vendor_plugin( $register = true, $handle = '', $src_cdn = false, $deps = array(), $ver = false, $footer_or_media = false, $is_script = true ) {
                if ( class_exists( 'Redux_VendorURL' ) ) {
                    $src = Redux_VendorURL::get_url( $handle );
