...
<?php } else { ?>
	...
	<p class="meta">
		...
		?><small>AT</small><time class="woocommerce-review__published-date" itemprop="datePublished" datetime="<?php echo get_comment_date( 'c' ); ?>"><?php echo get_comment_date( wc_date_format() ); ?></time>
	</p>
