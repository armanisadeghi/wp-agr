<?php
/**
 * The template for displaying single podcast transcript page
 *
...
while ( have_posts() ): the_post();
	$podcast_id          = get_post_meta( get_the_ID(), '_qwl_podcast_id', 1 );
	$video_url           = get_post_meta( $podcast_id, '_qwl_video_url', 1 );
	$video_screenshot    = get_post_meta( $podcast_id, '_qwl_video_screenshot', 1 );
	$episode_count       = get_post_meta( $podcast_id, '_qwl_episode_count', 1 );
	$audio_file          = get_post_meta( $podcast_id, "_qwl_audio_file", 1 );
        ...
        <div class="holder">
            ...
            <div class="itunes-link">
                <a href="<?php echo $podcast_link; ?>">
                    <img src="<?php echo home_url( 'images/itunes-icon.png' ); ?>" alt="iTunes">
                </a>
            </div>
