<?php
/*
 * Template Name: SST ThanksYou New
 */
get_header(); ?>
   <!-- Page Header -->
<?php
                                    ...
                                    <div class="billboard-content">
                                        <div class="detail">
                                            ...
                                            <?php //if ( '' != $banner['_ttm_banner_slider_btn_txt'] || '' != $banner['_ttm_banner_slider_btn_url'] ): ?>
                                                <br/>
                                                 <span class="thankyouphone"><?php do_action('mok_phone_number'); ?></span>
                                            <?php //endif; ?>
                                        </div>
                                    </div>
                                </div>
   ...
   <!--     <div class="blog-posts">
            <div class="holder">
                ...
                if ( $query_result->have_posts() ): ?>
                    <h1 class="post-title">Learn More Reading Our Newest Blog Posts</h1>
